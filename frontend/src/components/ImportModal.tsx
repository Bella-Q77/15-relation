...
const ImportModal: React.FC<ImportModalProps> = ({ visible, onClose }) => {
  ...
  const handleImportJSON = async () => {
    ...
    await actions.importJSON(jsonText);
  ...
  const handleImportCSV = async () => {
    ...
    if (csvType === 'entities') {
      await actions.importCSVEntities(csvText);
    } else {
      await actions.importCSVRelationships(csvText);
    }
              ...
              <div>
                ...
                <Button
                  ...
                  onClick={async () => {
                    ...
                    await actions.importJSON(JSON.stringify(demoData));
